...
final List<_LevelData> _levels = [
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(4, 1), Point(3, 1), Point(2, 1), Point(1, 1)],
      [Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2), Point(3, 2), Point(4, 2), Point(4, 3), Point(3, 3)],
      [Point(2, 3), Point(1, 3), Point(0, 3), Point(0, 4), Point(1, 4), Point(2, 4), Point(3, 4), Point(4, 4)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(1, 4), Point(1, 3), Point(1, 2), Point(1, 1)],
      [Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2), Point(2, 3), Point(2, 4), Point(3, 4), Point(3, 3)],
      [Point(3, 2), Point(3, 1), Point(3, 0), Point(4, 0), Point(4, 1), Point(4, 2), Point(4, 3), Point(4, 4)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(4, 1), Point(3, 1)],
      [Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2)],
      [Point(3, 2), Point(4, 2), Point(4, 3), Point(3, 3), Point(2, 3), Point(1, 3)],
      [Point(0, 3), Point(0, 4), Point(1, 4), Point(2, 4), Point(3, 4), Point(4, 4)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(1, 4), Point(1, 3)],
      [Point(1, 2), Point(1, 1), Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2)],
      [Point(2, 3), Point(2, 4), Point(3, 4), Point(3, 3), Point(3, 2), Point(3, 1)],
      [Point(3, 0), Point(4, 0), Point(4, 1), Point(4, 2), Point(4, 3), Point(4, 4)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(5, 0), Point(5, 1), Point(4, 1), Point(3, 1)],
      [Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2), Point(3, 2), Point(4, 2), Point(5, 2)],
      [Point(5, 3), Point(4, 3), Point(3, 3), Point(2, 3), Point(1, 3), Point(0, 3), Point(0, 4), Point(1, 4), Point(2, 4)],
      [Point(3, 4), Point(4, 4), Point(5, 4), Point(5, 5), Point(4, 5), Point(3, 5), Point(2, 5), Point(1, 5), Point(0, 5)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(0, 5), Point(1, 5), Point(1, 4), Point(1, 3)],
      [Point(1, 2), Point(1, 1), Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2), Point(2, 3), Point(2, 4), Point(2, 5)],
      [Point(3, 5), Point(3, 4), Point(3, 3), Point(3, 2), Point(3, 1), Point(3, 0), Point(4, 0), Point(4, 1), Point(4, 2)],
      [Point(4, 3), Point(4, 4), Point(4, 5), Point(5, 5), Point(5, 4), Point(5, 3), Point(5, 2), Point(5, 1), Point(5, 0)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(5, 0), Point(5, 1), Point(4, 1)],
      [Point(3, 1), Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2)],
      [Point(3, 2), Point(4, 2), Point(5, 2), Point(5, 3), Point(4, 3), Point(3, 3), Point(2, 3)],
      [Point(1, 3), Point(0, 3), Point(0, 4), Point(1, 4), Point(2, 4), Point(3, 4), Point(4, 4)],
      [Point(5, 4), Point(5, 5), Point(4, 5), Point(3, 5), Point(2, 5), Point(1, 5), Point(0, 5)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(0, 5), Point(1, 5), Point(1, 4)],
      [Point(1, 3), Point(1, 2), Point(1, 1), Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2)],
      [Point(2, 3), Point(2, 4), Point(2, 5), Point(3, 5), Point(3, 4), Point(3, 3), Point(3, 2)],
      [Point(3, 1), Point(3, 0), Point(4, 0), Point(4, 1), Point(4, 2), Point(4, 3), Point(4, 4)],
      [Point(4, 5), Point(5, 5), Point(5, 4), Point(5, 3), Point(5, 2), Point(5, 1), Point(5, 0)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(5, 0), Point(6, 0), Point(6, 1), Point(5, 1), Point(4, 1)],
      [Point(3, 1), Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2), Point(3, 2), Point(4, 2), Point(5, 2)],
      [Point(6, 2), Point(6, 3), Point(5, 3), Point(4, 3), Point(3, 3), Point(2, 3), Point(1, 3), Point(0, 3), Point(0, 4), Point(1, 4)],
      [Point(2, 4), Point(3, 4), Point(4, 4), Point(5, 4), Point(6, 4), Point(6, 5), Point(5, 5), Point(4, 5), Point(3, 5), Point(2, 5)],
      [Point(1, 5), Point(0, 5), Point(0, 6), Point(1, 6), Point(2, 6), Point(3, 6), Point(4, 6), Point(5, 6), Point(6, 6)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(0, 5), Point(0, 6), Point(1, 6), Point(1, 5), Point(1, 4)],
      [Point(1, 3), Point(1, 2), Point(1, 1), Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2), Point(2, 3), Point(2, 4), Point(2, 5)],
      [Point(2, 6), Point(3, 6), Point(3, 5), Point(3, 4), Point(3, 3), Point(3, 2), Point(3, 1), Point(3, 0), Point(4, 0), Point(4, 1)],
      [Point(4, 2), Point(4, 3), Point(4, 4), Point(4, 5), Point(4, 6), Point(5, 6), Point(5, 5), Point(5, 4), Point(5, 3), Point(5, 2)],
      [Point(5, 1), Point(5, 0), Point(6, 0), Point(6, 1), Point(6, 2), Point(6, 3), Point(6, 4), Point(6, 5), Point(6, 6)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(5, 0), Point(6, 0), Point(6, 1), Point(5, 1)],
      [Point(4, 1), Point(3, 1), Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2)],
      [Point(3, 2), Point(4, 2), Point(5, 2), Point(6, 2), Point(6, 3), Point(5, 3), Point(4, 3), Point(3, 3)],
      [Point(2, 3), Point(1, 3), Point(0, 3), Point(0, 4), Point(1, 4), Point(2, 4), Point(3, 4), Point(4, 4)],
      [Point(5, 4), Point(6, 4), Point(6, 5), Point(5, 5), Point(4, 5), Point(3, 5), Point(2, 5), Point(1, 5)],
      [Point(0, 5), Point(0, 6), Point(1, 6), Point(2, 6), Point(3, 6), Point(4, 6), Point(5, 6), Point(6, 6)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(0, 5), Point(0, 6), Point(1, 6), Point(1, 5)],
      [Point(1, 4), Point(1, 3), Point(1, 2), Point(1, 1), Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2)],
      [Point(2, 3), Point(2, 4), Point(2, 5), Point(2, 6), Point(3, 6), Point(3, 5), Point(3, 4), Point(3, 3)],
      [Point(3, 2), Point(3, 1), Point(3, 0), Point(4, 0), Point(4, 1), Point(4, 2), Point(4, 3), Point(4, 4)],
      [Point(4, 5), Point(4, 6), Point(5, 6), Point(5, 5), Point(5, 4), Point(5, 3), Point(5, 2), Point(5, 1)],
      [Point(5, 0), Point(6, 0), Point(6, 1), Point(6, 2), Point(6, 3), Point(6, 4), Point(6, 5), Point(6, 6)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(5, 0), Point(6, 0), Point(7, 0), Point(7, 1), Point(6, 1), Point(5, 1)],
      [Point(4, 1), Point(3, 1), Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2), Point(3, 2), Point(4, 2), Point(5, 2)],
      [Point(6, 2), Point(7, 2), Point(7, 3), Point(6, 3), Point(5, 3), Point(4, 3), Point(3, 3), Point(2, 3), Point(1, 3), Point(0, 3), Point(0, 4)],
      [Point(1, 4), Point(2, 4), Point(3, 4), Point(4, 4), Point(5, 4), Point(6, 4), Point(7, 4), Point(7, 5), Point(6, 5), Point(5, 5), Point(4, 5)],
      [Point(3, 5), Point(2, 5), Point(1, 5), Point(0, 5), Point(0, 6), Point(1, 6), Point(2, 6), Point(3, 6), Point(4, 6), Point(5, 6)],
      [Point(6, 6), Point(7, 6), Point(7, 7), Point(6, 7), Point(5, 7), Point(4, 7), Point(3, 7), Point(2, 7), Point(1, 7), Point(0, 7)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(1, 0), Point(2, 0), Point(3, 0), Point(4, 0), Point(5, 0), Point(6, 0), Point(7, 0), Point(7, 1), Point(6, 1)],
      [Point(5, 1), Point(4, 1), Point(3, 1), Point(2, 1), Point(1, 1), Point(0, 1), Point(0, 2), Point(1, 2), Point(2, 2)],
      [Point(3, 2), Point(4, 2), Point(5, 2), Point(6, 2), Point(7, 2), Point(7, 3), Point(6, 3), Point(5, 3), Point(4, 3)],
      [Point(3, 3), Point(2, 3), Point(1, 3), Point(0, 3), Point(0, 4), Point(1, 4), Point(2, 4), Point(3, 4), Point(4, 4)],
      [Point(5, 4), Point(6, 4), Point(7, 4), Point(7, 5), Point(6, 5), Point(5, 5), Point(4, 5), Point(3, 5), Point(2, 5)],
      [Point(1, 5), Point(0, 5), Point(0, 6), Point(1, 6), Point(2, 6), Point(3, 6), Point(4, 6), Point(5, 6), Point(6, 6)],
      [Point(7, 6), Point(7, 7), Point(6, 7), Point(5, 7), Point(4, 7), Point(3, 7), Point(2, 7), Point(1, 7), Point(0, 7)],
    ],
  ),
  ...
  _LevelData(
    ...
    solution: [
      [Point(0, 0), Point(0, 1), Point(0, 2), Point(0, 3), Point(0, 4), Point(0, 5), Point(0, 6), Point(0, 7), Point(1, 7), Point(1, 6)],
      [Point(1, 5), Point(1, 4), Point(1, 3), Point(1, 2), Point(1, 1), Point(1, 0), Point(2, 0), Point(2, 1), Point(2, 2)],
      [Point(2, 3), Point(2, 4), Point(2, 5), Point(2, 6), Point(2, 7), Point(3, 7), Point(3, 6), Point(3, 5), Point(3, 4)],
      [Point(3, 3), Point(3, 2), Point(3, 1), Point(3, 0), Point(4, 0), Point(4, 1), Point(4, 2), Point(4, 3), Point(4, 4)],
      [Point(4, 5), Point(4, 6), Point(4, 7), Point(5, 7), Point(5, 6), Point(5, 5), Point(5, 4), Point(5, 3), Point(5, 2)],
      [Point(5, 1), Point(5, 0), Point(6, 0), Point(6, 1), Point(6, 2), Point(6, 3), Point(6, 4), Point(6, 5), Point(6, 6)],
      [Point(6, 7), Point(7, 7), Point(7, 6), Point(7, 5), Point(7, 4), Point(7, 3), Point(7, 2), Point(7, 1), Point(7, 0)],
    ],
  ),
];
...
class _FlowConnectPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final entry in pipes.entries) {
      ...
      final uiPath = Path()..moveTo(centerOf(path.first).dx, centerOf(path.first).dy);
